<template>
  <SJSearchOneLayout>
    ...
    <template #default>
      ...
      <SJSearchField label="기준년도">
        <SJSelect
          id="searchCompany"
          name=""
          :options="[{text: '2023',value: '2023'},{text: '2024',value: '2024'}]"
          disabled-validation
          disabled-first-message
        />
      </SJSearchField>
      <SJSearchField label="월">
        <SJSelect
          id="searchCompany"
          name=""
          :options="[{text: '1월',value: '1월'},{text: '2월',value: '2월'},{text: '3월',value: '3월'}]"
          disabled-validation
          disabled-first-message
        />
      </SJSearchField>
