<template>
  <SJSearchTBLayout>
    ...
    <template #topTitle>
      <SJTitle title="작업지시">
        <button class="btn-blue-bg" @click="workStart">
          작업시작
        </button>
        <button class="btn-blue-bg" @click="workEnd">
          작업종료
        </button>
      </SJTitle>
    </template>
    ...
    <template #bottom>
      <SJTab :list="tabList">
        <template #tab-1>
          <SJTitle title="목록">
            <button class="btn-blue-bg" @click="resultAdd">
              추가
            </button>
            <button class="btn-blue-bg" @click="resultDel">
              삭제
            </button>
          </SJTitle>
        ...
        <template #tab-2>
          <SJTitle title="목록">
            ...
            <button class="btn-blue-bg" @click="purchaseApply">
              예약자재적용
            </button>
          </SJTitle>
...
export default {
  ...
  methods: {
    async workStart () {
      await this.$notify.info('작업시작')
    },
    async workEnd () {
      await this.$notify.info('작업종료')
    },
    async resultAdd () {
      await this.$notify.info('추가')
    },
    async resultDel () {
