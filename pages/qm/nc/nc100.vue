      ...
      <SJForm>
        ...
        <SJFormRow>
          <SJFormField label="비고">
            <SJTextarea
              id="f27"
              v-model="formcodes.f27"
              name="비고"
            />
          </SJFormField>
        </SJFormRow>
      </SJForm>
      <SJTitle title="부적합처리 현황" />
      <SJGrid
        ref="grid2"
        v-model="grid2.data"
