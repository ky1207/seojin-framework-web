    ...
    return {
      ...
      grid: {
        ...
        columns: [
          ...
          { name: '부가세', width: 100 },
          { name: '합계', width: 100 },
          { name: '발주서(국문)', width: 100 },
          { name: '발주서(영문)', width: 100 },
          { name: 'SellBack여부', width: 100 },
          { name: '발주형태명', width: 100 },
          { name: '수입여부', width: 100 },
          { name: '입출고형태', width: 100 },
          { name: '사급형태', width: 100 },
          { name: '결재방법', width: 100 },
          { name: '가격조건', width: 100 },
          { name: '운송방법', width: 100 },
  ...
  methods: {
    ACTION_REGISTRY () {
      ...
      return {
        ...
        // 신규
        f1Click: async () => {
          const result = await this.$refs.pu301Pop.open()
          if (result) {
            console.log('check')
          }
        },
