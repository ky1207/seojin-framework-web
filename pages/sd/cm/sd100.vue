    ...
    <template #default>
      <SJSearchField label="회사">
        <SJSelect
          ...
          name="sd1"
          :options="[
            { text: '서진본사', value: '서진본사' },
            { text: '서진베트남', value: '서진베트남' },
          ]"
          disabled-validation
          ...
          <template #tab-1>
            ...
            <SJFormRow>
              ...
              <SJFormField label="거래처명(약명)">
                <SJInput
                  ...
                  v-model="inputData.REPRESENTATIVE_NAME"
                  name="거래처명(약명)"
                />
              </SJFormField>
            </SJFormRow>
            <SJFormRow>
              <SJFormField label="대표이메일">
                <SJInput
                  ...
                  v-model="inputData.REPRESENTATIVE_EMAIL"
                  name="대표이메일"
                />
              </SJFormField>
            ...
            <SJFormRow>
              <SJFormField label="거래시작일">
                <SJInput
                  id="tradeStartDay"
                  v-model="inputData.TRADE_START_DAY"
                  name="거래시작일"
                />
              </SJFormField>
              <SJFormField label="거래종료일">
                <SJInput
                  id="tradeEndDay"
                  v-model="inputData.TRADE_END_DAY"
                  name="거래종료일"
                />
              </SJFormField>
            </SJFormRow>
          ...
          <template #tab-2>
            ...
            <SJFormRow>
              <SJFormField label="대표전화번호">
                <SJInput
                  id="representativeTelNo"
                  v-model="inputData.REPRESENTATIVE_TEL_NO"
                  name="대표전화번호"
                  rules="required"
                />
              </SJFormField>
            ...
            <SJFormRow>
              <SJFormField label="영업담당자명1">
                <SJInput
                  id="traderName1"
                  v-model="inputData.TRADER_NAME1"
                  name="영업담당자명1"
                />
              </SJFormField>
              <SJFormField label="영업담당자연락처1">
                <SJInput
                  id="traderTelNo1"
                  v-model="inputData.TRADER_TEL_NO1"
                  name="영업담당자연락처1"
                />
              </SJFormField>
            </SJFormRow>
            <SJFormRow>
              <SJFormField label="영업담당자명2">
                <SJInput
                  id="traderName2"
                  v-model="inputData.TRADER_NAME2"
                  name="영업담당자명2"
                />
              </SJFormField>
              <SJFormField label="영업담당자연락처2">
                <SJInput
                  id="traderTelNo2"
                  v-model="inputData.TRADER_TEL_NO2"
                  name="영업담당자연락처2"
                />
              </SJFormField>
            </SJFormRow>
          ...
          <template #tab-3>
            ...
            <SJFormRow>
              ...
              <SJFormField label="거래처담당자연락처">
                <SJInput
                  id="clientTelNo"
                  v-model="inputData.CLIENT_TEL_NO"
                  name="거래처담당자연락처"
                />
              </SJFormField>
            </SJFormRow>
          ...
          <template #tab-4>
            ...
            <SJFormRow>
              ...
              <SJFormField label="부가세율">
                <SJInput
                  id="supertaxRate"
                  v-model="inputData.SUPERTAX_RATE"
                  name="부가세율"
                />
              </SJFormField>
            </SJFormRow>
            <SJFormRow>
              <SJFormField label="결제조건">
                <SJInput
                  id="payCondition"
                  v-model="inputData.PAY_CONDITION"
                  name="결제조건"
                  rules="required"
                />
              </SJFormField>
            ...
            <SJFormRow>
              ...
              <SJFormField label="예금주">
                <SJInput
                  id="accountHolder"
                  v-model="inputData.ACCOUNT_HOLDER"
                  name="예금주"
                />
              </SJFormField>
            </SJFormRow>
            <SJFormRow>
              <SJFormField label="계좌번호">
                <SJInput
                  id="accountNumber"
                  v-model="inputData.ACCOUNT_NUMBER"
                  name="계좌번호"
                />
              </SJFormField>
