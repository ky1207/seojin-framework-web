<template>
  <SJModal ref="modal" size="modal-xl">
    ...
    <template #button>
      <button class="btn-blue-bg" @click="run">
        실행
      </button>
...
export default {
  ...
  methods: {
    ...
    async run () {
      await this.$notify.info('실행')
    },
    async confirm () {
      await this.$notify.info('확정')
    },
    close () {
