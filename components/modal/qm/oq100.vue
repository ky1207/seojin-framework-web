    ...
    <template #default>
      <SJSearchLRLayout disabled-navigator-wrap>
        <template #default>
          ...
          <SJSearchField label="Z-TAG Serial">
            <SJInput
              id="search16"
              name="Z-TAG Serial"
              disabled
          ...
          <SJSearchField label="내용">
            <SJTextarea id="search20" name="내용" />
          </SJSearchField>
          <SJSearchField label="파일첨부">
...
.search-field{
  width: 230px;}
.search-field:nth-child(21),
.search-field:nth-child(22){
  width: 100% !important;
}
</style>
