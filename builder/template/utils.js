...
export function interopDefault (promise,routeName) {   //kskim routename 추가
...
export function sanitizeComponent (Component) {
  ...
  if (!Component.options.name && Component.options.__route) { //kskim 선행으로 먼저 처리
    Component.options.name = Component.options.__route
  }
